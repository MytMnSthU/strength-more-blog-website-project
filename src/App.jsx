...
const SecondaryButton = ({ children }) => {
    return (
        <button
            type="button"
            className=" px-12 py-4 text-base font-bold uppercase text-black bg-transparent border-2 border-black rounded-[15px]"
        >
            {children}
        </button>
    );
...
const App = () => {
    ...
    const [currentArticlesCount, setCurrentArticlesCount] = useState(4);
